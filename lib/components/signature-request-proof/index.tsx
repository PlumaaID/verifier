      ...
      <ThemeProvider defaultTheme="light" storageKey="plumaa-id-verifier-theme">
        <Card {...props}>
          <CardHeader>
            ...
            <CardDescription>
              Esta verificación es equivalente a una prueba pericial para
              determinar la conservación de un documento electrónico.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex gap-3 flex-col">
              ...
              <p className="text-sm text-muted-foreground">
                Este documento ha sido firmado criptográficamente. Para asegurar
                la integridad del documento, el firmante realiza una operación
                sobre su digestivo utilizando el algoritmo
              ...
              <CardContent className="flex grow items-center justify-between py-3 gap-3">
                ...
                <code className="relative rounded bg-muted px-[0.3rem] py-[0.2rem] font-mono text-sm font-semibold break-anywhere">
                  {proof.hash}
                </code>
              </CardContent>
              <Separator />
              ...
              <p className="text-sm text-muted-foreground">
                ...
                {Object.keys(proof.conservation).length} métodos de
                conservación. Estos métodos garantizan que el documento no ha
                sido alterado desde su creación y añaden fecha cierta a su
                existencia.
              </p>
              <Separator />
              <Conservation
              ...
              {proof.signatures.map((signature) => (
                <SignatureProof key={signature.signature} proof={signature} />
              ))}
            </div>
          </CardContent>
        </Card>
